      ...
      <Row className={`m-top-100`}>
        ...
        >
          <div className={` ${Projectpage.detailDiv}`}>
            ...
            <p className={`text-align-center`}>
              Our user flow provided a streamlined and efficient user
              experience, reducing confusion and delays by offering clear
              instructions and manageable tasks.
            </p>
          </div>
        </Col>
        <Col xl={{ span: 10, offset: 1 }} id='detail-img-trigger-2'>
          <div className={`m-top-25 tablet-m-top-0`}>
            <StaticImage
              src='https://res.cloudinary.com/stevekim/image/upload/q_auto/v1710532808/FSD/userf-flow_uzooq5.webp'
              placeholder='blurred'
              alt='sitemap img'
